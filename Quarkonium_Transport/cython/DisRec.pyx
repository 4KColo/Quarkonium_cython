...
cdef extern from "../src/DisRec.h":
	...
	cdef double S2S_decay_ineq_p1(double p1low, double p1up, void * params_)
	cdef double S2S_decay_ineq_cos1(double p1, void * params_)
	cdef vector[double] S2S_decay_ineq(double v, double T)
	cdef vector[double] S2S_decay_ineq_test(double v, double T)
	...
	cdef vector[double] S2S_decay_ineg(double v, double T)
	cdef vector[double] S2S_decay_ineg_test(double v, double T)
	...
	cdef vector[double] S2S_reco_ineq(double v, double T, double p)
	cdef vector[double] S2S_reco_ineq_test(double v, double T, double p)
	...
	cdef vector[double] S2S_reco_ineg(double v, double T, double p)
	cdef vector[double] S2S_reco_ineg_test(double v, double T, double p)
